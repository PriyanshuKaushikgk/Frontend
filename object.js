...
//         // ans.
        ...
        //     if (person.mobile && person.mobile.toLowerCase().includes("apple")) {
        //         console.log(person.mobile);
        //     }
        // });

        // let name = myarray
        //   .filter(person=>person.mobile.includes('apple'))
        //   .map(person=> person.mobile);
        //   console.log(name);
          
    //       let name = myarray
    //       .filter(person => person.mobile && person.mobile.includes('apple'))
    //       .map(person => person.mobile);
